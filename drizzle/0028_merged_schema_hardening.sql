...
CREATE UNIQUE INDEX `integration_connections_provider_external_account_unique` ON `integration_connections` (`provider`,`external_account_ref`);--> statement-breakpoint
