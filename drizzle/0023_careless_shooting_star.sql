...
INSERT INTO `__new_workspace_documents`("id", "organization_id", "document_type", "file_name", "object_key", "content_type", "size_bytes", "sha256_hex", "security_state", "status", "extraction_status", "extracted_json", "uploaded_by_user_id", "created_at", "updated_at") SELECT "id", "organization_id", "document_type", "file_name", "object_key", "content_type", "size_bytes", "sha256_hex", 'quarantined', "status", "extraction_status", "extracted_json", "uploaded_by_user_id", "created_at", "updated_at" FROM `workspace_documents`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `integration_connections_provider_external_account_unique` ON `integration_connections` (`provider`,`external_account_ref`);
