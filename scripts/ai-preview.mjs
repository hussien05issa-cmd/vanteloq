...
const names=['globals','operating','theme','brand','design-v2','readability','experience','workspace-design','vanteloq-ai-brand','typography','product-demo','interface-polish'];
