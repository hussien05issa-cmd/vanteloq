...
const articles: readonly ResourceArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "comparison-chart",
        heading: "How BookLoQ fits beside other financial tools",
        paragraphs: [
          "Financial products are built around different primary jobs. This chart compares typical product categories, not every provider or plan. Capabilities vary, and a business may use more than one category.",
          "Swipe or scroll horizontally to compare every category.",
        ],
        table: {
          caption: "BookLoQ and other financial-tool categories by primary job",
          headers: ["Capability", "BookLoQ today", "General accounting software", "Commerce settlement tools", "Reporting and planning tools"],
          rows: [
            ["Primary job", "Review commerce-related financial records, supporting evidence, journals, statements and near-term cash in one workspace.", "Maintain books across banking, invoices, bills, expenses, reporting and month-end work.", "Break commerce settlements into sales, refunds, fees, taxes and deposits.", "Turn accounting data into management reports, KPIs, forecasts and scenarios."],
            ["Accounting record", "Keep posted journals and financial statements beside imported source records.", "Commonly serve as the accounting system of record.", "Usually prepare summarized entries for an accounting system.", "Usually read from accounting systems rather than posting the books."],
            ["Evidence and review", "Keep invoices, receipts, matched records, statuses and unresolved work visible for human review.", "Attachments, bank rules and review depth vary by product and plan.", "Centre evidence on settlement batches and payout matching.", "Usually explain variances from imported data rather than managing original evidence."],
            ["Commerce context", "Bring sales, documents, accounting records and cash context together. Depth depends on connected or imported sources.", "May receive commerce summaries or application data. Transaction detail varies by connection.", "Specialize in settlement composition and payout-to-deposit matching.", "Usually analyze summarized operational and financial data."],
            ["Cash planning", "Provide a 13-week forecast with verified opening cash, confirmed commitments, expected receipts and visible assumptions.", "Cash-flow reporting and forecasting vary by product and plan.", "Cash forecasting is usually outside the primary workflow.", "Forecasts, budgets and scenarios are common, using imported actuals and assumptions."],
            ["Review workflow", "Prioritize open items with their source, status, owner and next action.", "Rules, matching and approval workflows vary by product and plan.", "Focus review on mappings, exceptions and payout differences.", "Focus review on variances, assumptions and management commentary."],
            ["Automation boundary", "Suggestions remain subject to authorized human review. Vanteloq AI cannot post journals or approve payments.", "Automation varies; users remain responsible for review, filing and professional judgment.", "Automate mapping and summary preparation, with exceptions left for review.", "Explain trends and scenarios; source quality and assumptions still govern the result."],
            ["Current limits", "BookLoQ does not file returns, move money or certify completeness. QuickBooks connectivity remains sandbox-only.", "Tax, payroll, payments and filing differ by region and subscription.", "Require supported commerce channels and an accounting destination.", "Depend on connected accounting and operating data."],
          ],
        },
        callout: {
          title: "Category comparison, not a vendor ranking",
          body: "Capabilities vary by provider, plan, region and connection. BookLoQ does not file tax returns, move money, approve accounting decisions or certify that the books are complete. QuickBooks connectivity remains sandbox-only. Review connection status before relying on an import.",
        },
      },
      {
        id: "sale-to-bank",
