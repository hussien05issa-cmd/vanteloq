  ...
  return (
    <div className="content control-page documents-centre">
      ...
      {review && <section className="card document-extraction-review" aria-label={`Extraction review for ${review.fileName}`}>
        <header><div><p>EXTRACTION REVIEW</p><h3>{review.fileName}</h3><span>{review.extraction.pages} {review.extraction.pages === 1 ? "page" : "pages"} · Proposed figures · No accounting entries posted</span></div><button onClick={() => setReview(null)}>Close Review</button></header>
