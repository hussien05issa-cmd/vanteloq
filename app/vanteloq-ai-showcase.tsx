...
export default function VanteloqAiShowcase() {
  return <aside className="home-ai-mark ai-orbit-showcase" aria-label="Vanteloq AI">
    ...
    <div className="ai-orbit-wordmark"><span>VANTELOQ <b>AI</b></span><p>Your store’s numbers,<br/>in conversation.</p></div>
    <div className="ai-orbit-topics"><span>Sales & margin</span><span>Cash & books</span><span>App help</span></div>
