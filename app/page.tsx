...
function LandingPage() {
  ...
  return <main className="public-site">
    <header className="public-nav"><button className="public-brand" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}><ProductBrandLogo product="vanteloq" priority/><span>Vanteloq<small>OPERATING INTELLIGENCE</small></span></button><nav><a href="#platform">Platform</a><a href="#products">Products</a><a href="#connect">Data</a><a href="#how">How it works</a></nav><div><a className="nav-login" href="/signin-with-chatgpt?return_to=/">Sign in</a><button onClick={start}>Create workspace</button></div></header>
    ...
    <footer className="public-footer"><div><ProductBrandLogo product="vanteloq"/><strong>Vanteloq</strong><span className="footer-product-divider"/><ProductBrandLogo product="bookloq"/><strong>BookLoQ</strong></div><p>Clarity for every operating decision.</p><button onClick={start}>Create workspace →</button></footer>
  </main>;
}
