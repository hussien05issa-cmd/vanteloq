// Brand glyphs: Bootstrap Icons (MIT). See /licenses/bootstrap-icons.txt.
const socialProfiles = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/vanteloq.commerce/",
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/channel/UCRQuI8OxAHLxO9wMqyj9IdQ",
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@vanteloq.commerce",
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/1DcLPHyYk9/?mibextid=wwXIfr",
...
export default function SocialLinks() {
  return <div className="public-social-links" role="group" aria-label="Follow Vanteloq">
    {socialProfiles.map(profile => <a
      key={profile.name}
      className={`public-social-link social-${profile.name.toLowerCase()}`}
      href={profile.href}
      target="_blank"
      rel="noopener noreferrer"
      aria-label={`Vanteloq on ${profile.name} (opens in a new tab)`}
      title={`${profile.name} (opens in a new tab)`}
    >
      <svg viewBox="0 0 16 16" width="20" height="20" fill="currentColor" aria-hidden="true" focusable="false"><path d={profile.path}/></svg>
    </a>)}
  </div>;
}
