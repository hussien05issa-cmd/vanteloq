...
function ProductLeaderboard({ products, sort, setSort, navigate }: { products: Product[]; sort: "revenue"|"profit"|"margin"; setSort:(v:"revenue"|"profit"|"margin")=>void; navigate:(v:string)=>void }) {
...
function ProductAnalysis({ products, sort, setSort, showNotice, navigate }: { products:Product[]; sort:"revenue"|"profit"|"margin"; setSort:(v:"revenue"|"profit"|"margin")=>void; showNotice:(m:string)=>void; navigate:(v:string)=>void }) {
