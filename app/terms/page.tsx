  ...
  return (
    <LegalShell eyebrow="TERMS OF SERVICE" title="The rules for using Vanteloq." summary="These terms explain account authority, acceptable use, customer data, service limits, and each party's responsibilities.">
      ...
      <PolicySection id="outputs" title="6. Calculations, recommendations, and professional advice">
        ...
        <p>Vanteloq does not replace an accountant, lawyer, tax professional, financial adviser, payroll professional, or other qualified adviser. Users must review material decisions and source records. The customer remains responsible for filings, payments, employment decisions, purchase commitments, accounting entries, and business actions.</p>
      </PolicySection>
