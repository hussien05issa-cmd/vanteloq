  ...
  return (
    <LegalShell eyebrow="TERMS OF SERVICE" title="The rules for using Vanteloq." summary="These terms explain account authority, acceptable use, customer data, service limits, and each party's responsibilities.">
      ...
      <PolicySection id="accounts" title="3. Accounts and workspace administration">
        ...
        <p>A workspace owner represents that they are authorized to make decisions for the organization, including inviting or removing users, accepting current service terms, connecting providers, managing billing, exporting records, and permanently deleting workspace data and memberships. Workspace deletion does not authorize deletion of other members&apos; independent sign-in identities or accounts in separate services. The customer must promptly change access when a user&apos;s duties or employment changes.</p>
      </PolicySection>
      ...
      <PolicySection id="data" title="4. Customer data and connected services">
        ...
        <p>Third-party product names and permitted marks are used only to identify compatible or planned services. Those names and marks belong to their respective owners. Their display does not state or imply sponsorship, endorsement, certification, or partnership unless Vanteloq expressly identifies an authorized relationship. Availability labels and setup details control over any logo or name shown elsewhere in the service.</p>
      ...
      <PolicySection id="suspension" title="11. Suspension and termination">
        ...
        <p>Either party may end an unpaid service at any time. Paid services may be ended according to the order and cancellation controls. Protected deletion controls are available without a paid subscription, subject to verified identity, authority and the scope checks described in the Privacy Policy. Workspace deletion cancels Vanteloq billing and removes the active workspace, files, local credentials and memberships. Independent identities required by another workspace or service are preserved. A nonowner&apos;s deletion removes their Vanteloq profile and access while retaining customer business records with anonymous authorship where needed. Customers must export records they are required to retain before deletion. Pending cleanup is not a confirmation of completed deletion.</p>
