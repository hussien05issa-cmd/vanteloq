...
export function BusinessCashReport({ data }: { data: BookLoQData }) {
  ...
  return <section className="business-cash-report" aria-label="Business cash activity report">
    <header>
      <div><p>BUSINESS CASH ACTIVITY</p><h3>Actual inflows and outflows</h3><span>Recorded bank movements in your base currency. Pending activity, card balances and forecasts are excluded.</span></div>
