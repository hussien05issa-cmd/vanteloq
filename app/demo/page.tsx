...
export const metadata: Metadata = { title: "Interactive product demo | Vanteloq", description: "Explore Vanteloq with fictional retail data. Inspect KPI calculations, test missing data and model pricing assumptions. No account required.", alternates: { canonical: "/demo" } };
