...
import { getCategory, getReadingTime, type ResourceArticleSummary } from "./resources/metadata";
import type { ResourceArticle } from "./resources/content";

/** Native disclosure keeps the full catalogue in the HTML without a long wall of cards. */
export default function ResourceArticleBrowser({ articles, title = "Browse Articles" }: { articles: readonly (ResourceArticle | ResourceArticleSummary)[]; title?: string }) {
