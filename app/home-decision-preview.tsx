...
export default function HomeDecisionPreview() {
  ...
  return <div className="home-live-proof home-product-preview">
    ...
    <div className="home-proof-insight"><VanteloqAiLogo size={34} decorative/><div><strong>What changed behind the total?</strong><p>Compare baskets, product mix and discounts. Open the records before deciding what to change.</p><Link prefetch={false} href={"/demo?location=" + location + "#retail"} data-public-event="demo_engaged">Show me why <span aria-hidden="true">↗</span></Link></div></div>
