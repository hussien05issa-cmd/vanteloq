  ...
  return (
    <LegalShell eyebrow="PRIVACY POLICY" title="Your information should have a clear purpose." summary="This policy explains what Vanteloq handles, why it is needed, and the choices available to account holders and other individuals.">
      ...
      <PolicySection id="authority" title="4. Consent and workspace authority">
        ...
        <p>A financial connection begins only after an authorized user starts the connection and completes the provider consent flow. The connection screen identifies the intended account types and data categories. A workspace owner can disconnect the connection, which stops scheduled access and causes stored provider access credentials to be revoked or deleted. Imported transactions, reviewed accounting entries, source documents, and limited audit evidence may remain when needed for the service, legal recordkeeping, or a documented retention requirement.</p>
