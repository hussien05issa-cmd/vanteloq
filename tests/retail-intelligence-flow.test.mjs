...
test("retail Worker enforces tenant/location/privacy boundaries, source approval, evidence CRUD and AI consent", async () => {
  ...
  try {
    ...
    const askBody = { question: "Explain the retail performance", provider: "openai", dataUseAccepted: true, noticeVersion: "vanteloq-ai-v6-openai", privacyPolicyVersion: "2026-09-10", memoryEnabled: true, from: "2026-09-11", to: "2026-09-11", locationId: owner.locationId };
