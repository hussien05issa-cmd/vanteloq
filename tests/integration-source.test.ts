...
test("repeatable connector controls include Stripe, both Shopify channels, and both Lightspeed editions", () => {
  ...
  assert.equal(supportsMultipleProviderAccounts?.("shopify"), true);
